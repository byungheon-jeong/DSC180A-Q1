...
# datetime_object = date.fromisoformat(bad_dates[0])

# start_1 = datetime_object.replace(day=datetime_object.day + 1)

# end_1 = datetime_object.replace(day=datetime_object.day - 1)

# collection = collection.filter(ee.Filter.date(start_1, start_2).Not())
########################
